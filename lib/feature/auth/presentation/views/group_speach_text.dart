...
class _GroupSpeechToTextScreenState extends State<GroupSpeechToTextScreen> with TickerProviderStateMixin {
  ...
  Future<void> _initAssemblyConnection() async {
    try {
      ...
      _assemblyChannel!.sink.add(jsonEncode(sessionBegins));
      print('➡️ Sent: ${jsonEncode(sessionBegins)}');
        ...
        try {
          ...
          switch (type) {
            ...
            case 'SessionEnded':
              ...
              break;
            case 'Error':
              final err = data['error']?.toString() ?? message;
              print('⚠️ Error from AssemblyAI: $err');
              if (mounted) {
