...
class _GroupSpeechToTextScreenState extends State<GroupSpeechToTextScreen> with TickerProviderStateMixin {
  ...
  bool _containsPunjabi(String text) {
  ...
  String _toHinengPunjabi(String text) {
    const Map<String, String> map = {
      'ਅ': 'a',
      'ਆ': 'ā',
      'ਇ': 'i',
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          for (var speakerEntry in speakers) {
            ...
            String text = rawText;
            if (_containsHindi(rawText)) {
              text = _toHinglish(rawText);
            } else if (_containsPunjabi(rawText)) {
              text = _toHinengPunjabi(rawText);
            }
